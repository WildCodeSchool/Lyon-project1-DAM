        ...
        <div class="text col-md-4 col-xs-10 col-xs-pull-1 col-md-pull-0 ">
            <h3>Le saviez vous ?</h3>
                <p>Durables
                    ...
                    Nos insectes ont rejoint les fourchettes durables,<br>
                    aux côtés des fruits de saison, des poissons de ligne
                    ou des fromages artisanaux.<br>
        ...
        <div class="text col-md-4 col-xs-10 col-xs-pull-1 col-md-pull-0 ">
            <h3>Le saviez vous ?</h3>
                <p>
                    ...
                    Ils sont nés dans le coin, et n'iront pas beaucoup plus loin.<br>
                    Quel meilleur endroit que La Loupe pour élever des ténébrions et des grillons ? <br>
                    Ils ont toujours aimé la région.
                </p>
        </div>
        ...
        <div class="text col-md-pull-4 col-md-4 col-xs-10 col-xs-pull-1">
            <h3>Le saviez vous ?</h3>
                <p>Nos insectes ne mangent que les meilleurs légumes et céréales,<br>
                    ...
                    Nous leur donnons tout simplement ce dont ils ont besoin, et nous le choisissons bien. <br>
                    Pour déguster nos insectes,
                    nous avons dit non aux pesticides, aux OGM, aux colorants et arômes artificiels.
                </p>
        </div>
        ...
        <div class="text col-md-4 col-xs-10 col-xs-pull-1 col-md-pull-0">
            <h3>Le saviez vous ?</h3>
                <p>Un insecte comestible pour l'équivalent d'un bœuf c'est :<br>
                   ...
                   50 x moins d'eau <br>
                   100 x moins de gaz à effet de serre</strong>
                </p>
        </div>
